...
const config: HardhatUserConfig = {
  ...
  networks: {
    hardhat: {
      ...
      accounts: [
        ...
        // },
        {
          privateKey: `${process.env.PRIVATE_KEY_727 || dummyPrivateKey}`,
          balance: '1000000000000000000000000000000000000',
        },
        {
  ...
  etherscan: {
    ...
    apiKey: {
      ...
      'base-sepolia': 'ANY_STRING_WORKS_FOR_BLOCKSCOUT', // process.env.BASESCAN_API_KEY || '',
      'polygon-amoy': process.env.POLYGONSCAN_API_KEY, // process.env.BASESCAN_API_KEY || '',
